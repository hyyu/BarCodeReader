...
public class IntentIntegrator {
    ...
    public static final String DEFAULT_TITLE = "Install Barcode Reader?";
    ...
    public void setButtonYes(String message) {
        this.buttonYes = message;
    }

    public void setButtonYesByID(int messageID) {
        this.buttonYes = activity.getString(messageID);
    }
    ...
    public void setButtonNo(String message) {
        this.buttonNo = message;
    }

    public void setButtonNoByID(int messageID) {
        this.buttonNo = activity.getString(messageID);
    }
    ...
    public Map<String, Object> getMoreExtras() {
        return moreExtras;
    }
